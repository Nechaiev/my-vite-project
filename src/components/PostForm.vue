...
<template>
  <form class="flex flex-col" @submit.prevent>
    ...
    <my-input v-focus v-model="post.title" class="" type="text" placeholder="Name of the post" />
    <my-input v-model="post.body" class="" type="text" placeholder="Post description" />
