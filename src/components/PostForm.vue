...
<template>
  <form class="flex flex-col" @submit.prevent>
    ...
    <my-input v-focus v-model="post.title" class="input" type="text" placeholder="Назва поста" />
    <my-input v-model="post.body" class="input" type="text" placeholder="Опис поста" />
